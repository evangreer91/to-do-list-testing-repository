...
// constructor injection to take in data sources in constructor
// this way we can swap out the real data sources for fake ones
class DefaultTasksRepository constructor(
    ...
    // wrap appropriate methods performing long running tasks with the wrapEspressoIdlingResource function
