...
class TasksDaoTest {
    ...
    @Before
    fun initDb() {
        // Using an in-memory database so that the information stored disappears
    ...
    // we need to run test in runBlockingTest since database functions are run by coroutines
    @Test
