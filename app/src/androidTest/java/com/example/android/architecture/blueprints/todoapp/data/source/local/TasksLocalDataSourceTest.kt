...
class TasksLocalDataSourceTest {
    ...
    fun setup() {
        ...
        // add allowMainThreadQueries to allow queries to be run on the main thread for testing purposes
        ...
        // instantiate the local data source using database and main dispatcher
        localDataSource =
